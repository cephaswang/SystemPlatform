...
![AVEVA Historian 總覽](images/20_08.jpg)
...
![AVEVA Historian Client 四大分析工具](images/20_04.jpg)
...
![Query 工具產生 SQL 並查詢資料異常](images/20_09.jpg)
...
![使用 Query 工具查詢標籤詳細資訊](images/20_10.jpg)
...
![Excel Add-in 匯入 Historian 資料並製作報表](images/20_07.jpg)
...
![AVEVA Data Hub 中檢視延伸自製程的數位線程資料](images/20_06.jpg)
...
![設定複寫伺服器與目標複寫環境](images/20_11.jpg)
...
![Runtime Database 報表協助製程異常診斷](images/20_17.jpg)
